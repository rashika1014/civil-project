...
describe('AppComponent', () => {
  ...
  it('should have menu labels', async () => {
    ...
    expect(menuItems[1].textContent).toContain('Gallery');
    expect(menuItems[1].textContent).toContain('Services');
  ...
  it('should have urls', async () => {
    ...
    expect(menuItems[1].getAttribute('ng-reflect-router-link')).toEqual('/services');
